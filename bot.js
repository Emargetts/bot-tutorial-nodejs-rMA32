...
function respond() {
  var request = JSON.parse(this.req.chunks[0]),
      ...
      botRegexP = /^\/PDL/i;  botRegexTw = /^\/twitch/i; botRegexSb = /^\/sub/; botRegexhose = /^\/hose.jpg/; botRegexWk = /^\/users/;
  ...
  if(request.text && botRegexbg.test(request.text)) {
    ...
    var rep = req.replace(/ /,"+");
    postMessage("http://daddyleagues.com/lul/players?name="+rep+"&position=all&team=all");
    this.res.end();
  }  
